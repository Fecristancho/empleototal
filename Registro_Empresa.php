                    ...
                    if (preg_match('/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]{8,}$/', $contrasena)) {
                        try {
                            ...
                            if ($count > 0) {
                                ...
                                echo '<div class="alert alert-danger" role="alert">El nombre de la empresa ya existe, utiliza otro </div>';
                            } else {
                                ...
                                header("Location: Registro_Empresa_Formulario.php");
                                exit();
                            }
                        } catch (Exception $e) {
...
<head>
    ...
    <link rel="stylesheet" href="Registro_Empresa.css">
    ...
    <section class="formulario">
        ...
        <form method="POST" action="Registro_Empresa.php">
            <article class="campo">   
                ...
                <label for="usuario" class="form__label">Nombre de Empresa:</label>
            </article>
            <article class="campo">  
